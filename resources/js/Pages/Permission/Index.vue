                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-2">
                                <Link href="/permissions/create" class="btn btn-primary btn-block">
                                    Tambah
                                </Link>
                            </div>
                            <div class="form-group col-lg-2">
                                <Link href="/permissions" class="btn btn-success btn-block">Reset</Link>
                            </div>
                            <div class="form-group col-lg-2">
                        ...
                        <div>
                            <table class="table table-striped table-responsive-lg">
                                ...
                                <tbody>
                                    <tr v-for="item in permissions.data" :key="item.id">
                                        ...
                                        <td>
                                            <Link :href="`/permissions/edit/${item.id}`" title="Edit">
                            ...
                            <Pagination :data="permissions" :q="q" />
                        </div>
                    </div>
